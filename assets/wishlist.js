(() => {
 ...
 const ask=el('a','Ask Sam + Ryan');ask.className='mini-btn';ask.href='contact.html';ask.addEventListener('click',()=>{try{sessionStorage.setItem('samRyanWishlistInquiry',wish.criteria);}catch{status.textContent='Copy your preferences into the contact form.';}});actions.append(ask);
